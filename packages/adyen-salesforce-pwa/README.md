...
1. PWA v8
2. [Adyen Web v6.35.0](https://www.npmjs.com/package/@adyen/adyen-web)
3. [Adyen API Library for Node.js v32.0.0](https://www.npmjs.com/package/@adyen/api-library) (supports Checkout API v72)
4. Node v22 or later
5. NPM v11 or later
